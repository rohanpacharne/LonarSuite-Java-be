...
//		String query = "Select (sysdate() - access_token_date)*60*60*24 as differance_time, refresh_token from lt_token_details where access_token = ? ";
...
//		String query = "Select (sysdate - access_token_date)*60*60*24 as differance_time, access_token from my_token_details where old_access_token = ?";
		...
		String query = "Select TIMESTAMPDIFF(SECOND, NOW(),access_token_date) as differance_time, refresh_token from lt_token_details where old_access_token = ? ";
