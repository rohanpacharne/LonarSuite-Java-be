...
public interface LtMastCommunicationTabService {

	Status save(LtMastCommunicationTab ltMastCommunicationTab) throws ServiceException;
	...
	Status getCommunicationId(Long vendorId, Long companyId) throws ServiceException;
