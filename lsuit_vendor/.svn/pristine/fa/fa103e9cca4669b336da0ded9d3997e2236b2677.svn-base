...
public class LtVendCompanySistConcernDaoImpl implements LtVendCompanySistConcernDao{
	...
	@Override
	public List<LtCompanyVenMgmtInclude> getSistConcernBycompanyId(Long companyId, Long vendorId)
			throws ServiceException {
		String query = env.getProperty("getCompanyVenMgmtIncludeByCompanyVendor");
