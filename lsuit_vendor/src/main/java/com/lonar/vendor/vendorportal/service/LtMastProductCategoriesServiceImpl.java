...
public class LtMastProductCategoriesServiceImpl implements LtMastProductCategoriesService, CodeMaster {
	...
	public List<LtMastProductCategories> findByCategoryName(String categoryName) throws Exception{
		...
		return ltP2pProductCategoriesDao.findByCategoryName(categoryName);
	}

	@Override
	public List<LtMastProductCategories> findAllActive() throws Exception{
		// TODO Auto-generated method stub
		return ltP2pProductCategoriesDao.findAllActive();
	}

	@Override
	public List<LtMastProductCategories> findActiveLikeCategoryName(String categoryName) throws Exception{
		// TODO Auto-generated method stub
		return ltP2pProductCategoriesDao.findActiveLikeCategoryName(categoryName);
	}
	...
	public ResponseEntity<Status> update(LtMastProductCategories ltMastProductCategories) throws ServiceException {
		...
		try {
			ltMastProductCategoriesList = ltP2pProductCategoriesDao
						.findByCategoryName(ltMastProductCategories.getCategoryName());
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//			status=ltMastCommonMessageService.getCodeAndMessage(ENTITY_CANNOT_DELETE);
	...
	public Long getCount(LtMastProductCategories input) throws ServiceException {
		// TODO Auto-generated method stub
				return ltP2pProductCategoriesDao.getCount(input);
	}
	...
	public List<LtMastProductCategories> getDataTable(LtMastProductCategories input) throws ServiceException {
		...
		List<LtMastProductCategories> list= ltP2pProductCategoriesDao.getDataTable(input);
		return list;
	}
