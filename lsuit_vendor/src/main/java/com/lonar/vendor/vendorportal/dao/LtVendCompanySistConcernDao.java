...
public interface LtVendCompanySistConcernDao {
	...
	List<LtCompanyVenMgmtInclude> getSistConcernBycompanyId(Long companyId, Long vendorId) throws ServiceException;
