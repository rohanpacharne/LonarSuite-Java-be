...
public  class LtMastDivisionsServiceImpl implements LtMastDivisionsService ,CodeMaster
{
	...
	public List<LtMastDivisions> findAllActive() throws ServiceException{
		...
		ltMastDivisions = (List<LtMastDivisions>)  ltMastDivisionsDao.findAllActive();
	...
	public List<LtMastDivisions> findActiveLikeName(String divisionName) throws ServiceException{
		return  ltMastDivisionsDao.findActiveLikeName(divisionName);
	}
	...
	@Override
	public Long getCount(LtMastDivisions input) throws Exception {
		// TODO Auto-generated method stub
		return ltMastDivisionsDao.getCount(input);
	}

	@Override
	public List<LtMastDivisions> getDataTableRecords(LtMastDivisions input) throws Exception {
		...
		return ltMastDivisionsDao.getDataTableRecords(input);
	}

	@Override
	public List<LtMastDivisions> getAll() throws ServiceException {
		List<LtMastDivisions> ltMastDivisions =null;
