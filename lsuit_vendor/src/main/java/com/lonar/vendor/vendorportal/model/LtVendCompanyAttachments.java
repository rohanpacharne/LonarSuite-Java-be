...
public class LtVendCompanyAttachments 
{
	...
	public String getInclude_Vendor() {
		return includeVendor;
	}

	public void setInclude_Vendor(String includeVendor) {
	...
	public String toString() {
		return "LtVendCompanyAttachments [compAttachmentId=" + compAttachmentId + ", companyId=" + companyId
				...
				+ attachmentName + ", attachmentMandatory=" + attachmentMandatory + ", createdBy=" + createdBy
