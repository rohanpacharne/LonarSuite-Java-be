...
//	
//	public static final int VENDOR_APPROVED = 16;
//	public static final int VENDOR_REJECTED = 17;	
			
//	public static final int VENDOR_SENT_FOR_FEEDBACK=18;
	
//	public static final int DUPLICATE_CODE=19;
//	public static final int APPROVAL_ALREADY_PRESENT=20;
	
//	public static final int VENDOR_APPROVAL_FAIL=21;
...
//	public static final int VENDOR_WITHDRAW = 32;
	
	
//	public static final int INV_APPROVED = 51;
//	public static final int INV_REJECTED = 52;
//	public static final int INV_FEEDBACK_AWAITED = 53;
//	public static final int INVOICE_APPROVAL_FAIL = 55;
	
	
//	public static final int INVOICE_SUBMIT_FOR_APPROVAL = 36;
//	public static final int ADVANCE_REMARK_SAVED = 37;
//	public static final int ATTACHEMENT_DELETED_SUCCESS = 38;
//	public static final int ATTACHEMENT_DELETED_FAIL = 39;
...
//	public static final int SHIPMENT_APPROVED = 56;
//	public static final int SHIPMENT_REJECTED = 57;
//	public static final int SHIPMENT_FEEDBACK_AWAITED = 58;
//	public static final int SHIPMENT_APPROVAL_FAIL = 59;
//	public static final int SHIPMENT_REMARK_SAVED = 60;
//	public static final int SHIPMENT_SUBMIT_FOR_APPROVAL = 61;
...
//	public static final int FAIL = 502;
	...
	public static final String INVOICE_SENDING= "INVOICE_SENDING";
	public static final String INVOICE_PENDING= "PENDING";
	public static final String INVOICE_INPROGRESS="INVOICE_INPROGRESS";
	public static final String INVOICE_INPROCESS= "INVOICE_INPROCESS";
	
	
	public static final String INVOICE_APPROVED="INVOICE_APPROVED";
	public static final String INVOICE_REJECTED="INVOICE_REJECTED";
	public static final String INVOICE_WITHDRAW="INVOICE_WITHDRAW";
	public static final String INVOICE_FEEDBACK_AWAITED="INVOICE_FEEDBACKAWAITED";
	
	
	public static final String RA_DRAFT="RA_DRAFT";
	public static final String RA_APPROVED="RA_APPROVED";
	public static final String RA_REJECTED="RA_REJECTED";
	public static final String RA_INPROCESS = "RA_INPROCESS";
	public static final String RA_FEEDBACKAWAITED = "RA_FEEDBACKAWAITED";
...
//	public static final int PASS_LINK_SEND = 23; // login.passwordlinksend
