...
private JdbcTemplate jdbcTemplate;
	...
	public List<LtMastProducts> findByProductCode(String productCode) throws ServiceException {
		...
		List<LtMastProducts> list=   jdbcTemplate.query(query, new Object[]{ productCode }, 
	...
	public List<LtMastProducts> findActiveLikeName(String productName) throws ServiceException 
	{
		...
		List<LtMastProducts> list=   jdbcTemplate.query(query, new Object[]{ "%"+productName.trim().toUpperCase()+"%","%"+productName.trim().toUpperCase()+"%" }, 
					 new BeanPropertyRowMapper<LtMastProducts>(LtMastProducts.class)); 
	...
	public Long getCount(LtMastProducts input) throws ServiceException {
		...
		String count  = (String)getJdbcTemplate().queryForObject(
				query, new Object[] {prodCode,name,uom,type,
		 ...
		 String prodCode=null;
		   ...
		   {type="%"+input.getProductType().toUpperCase()+"%";}
			...
			List<LtMastProducts> list = (List<LtMastProducts>) 
					jdbcTemplate.query(query , new Object[]{prodCode,name,uom,type,
