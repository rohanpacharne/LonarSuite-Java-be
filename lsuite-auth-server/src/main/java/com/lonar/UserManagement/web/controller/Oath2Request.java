...
public class Oath2Request {
	...
	public AuthTokenInfo sendTokenRequest(String username, String password) {
		...
		System.out.println(response.toString()+"userName--"+username+"\tpassowrd--"+password);
		...
		AuthTokenInfo tokenInfo = null;
		tokenInfo = new AuthTokenInfo();
		tokenInfo.setAccess_token("c2FtcGxlQ2xpZW50SWQ6c2VjcmV0");
		tokenInfo.setToken_type("Bearer");
		tokenInfo.setRefresh_token("c2FtcGxlQ2xpZW50SWQ6c2VjcmV0");
		tokenInfo.setExpires_in((int) 5000);
		tokenInfo.setScope((String) ("permit all"));
	...
	private HttpHeaders getHeadersWithClientCredentials() {
		String plainClientCredentials = "sampleClientId:secret";
