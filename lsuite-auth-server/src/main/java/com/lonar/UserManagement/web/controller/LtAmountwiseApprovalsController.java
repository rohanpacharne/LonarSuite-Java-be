...
public class LtAmountwiseApprovalsController {
		...
		@RequestMapping(value = "/datatable/{companyId}/{transactionCode}/{transactionType}/{logTime}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
		public CustomeDataTable getDataTable(
		    @PathVariable("companyId") Long companyId, 
		    @PathVariable("transactionCode") String transactionCode, 
		    @PathVariable("transactionType") String transactionType, 
		    @PathVariable("logTime") String logTime, LtMastAmountwiseApprovals input) {
		    try {
		        input.setTransactionCode(transactionCode);
		        input.setTransactionType(transactionType);
		        return ltMastAmountwiseApprovalsService.getLtMastAmountwiseApprovalsDataTable( companyId,transactionCode,transactionType,input);
		    } catch (Exception e) {
