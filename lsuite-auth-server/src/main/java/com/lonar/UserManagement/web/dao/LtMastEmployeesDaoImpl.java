...
*/
	...
	public boolean updatePath(LtMastEmployees ltMastEmployees) throws Exception
	{
		...
		int res=0;
		/*res=jdbcTemplate.update(" UPDATE lt_mast_employees SET IMAGE_PATH =? "
				+ "  WHERE EMPLOYEE_ID=? ",
     		ltMastEmployees.getImagePath(),ltMastEmployees.getEmployeeId());*/
		res=jdbcTemplate.update(query,ltMastEmployees.getImagePath(),ltMastEmployees.getEmployeeId());
	...
	public boolean update(LtMastEmployees ltMastEmployees) throws Exception
	{
		...
		int res=0;
		/* res=jdbcTemplate.update(" UPDATE lt_mast_employees SET "
	...
	@Override
	public List<LtMastEmployees> getByEmpIdForEmail(Long empId) throws Exception {
