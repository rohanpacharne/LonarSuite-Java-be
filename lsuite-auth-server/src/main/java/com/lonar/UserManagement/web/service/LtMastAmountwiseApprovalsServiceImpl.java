...
public class LtMastAmountwiseApprovalsServiceImpl implements LtMastAmountwiseApprovalsService,CodeMaster{
	...
	@Override
	public CustomeDataTable getLtMastAmountwiseApprovalsDataTable(Long companyId , String transactionCode , String transactionType,LtMastAmountwiseApprovals input)
	{ CustomeDataTable customeDataTable = new CustomeDataTable();
	    Long count = ltMastAmountwiseApprovalsDao.getLtMastUsersCount( companyId, transactionCode, transactionType,input);
	    customeDataTable.setRecordsTotal(count);
	    customeDataTable.setRecordsFiltered(count);
	    List<LtMastAmountwiseApprovals> ltMastAmountwiseApprovals = ltMastAmountwiseApprovalsDao.getLtMastUsersDatatableRecords( companyId, transactionCode, transactionType,input);
