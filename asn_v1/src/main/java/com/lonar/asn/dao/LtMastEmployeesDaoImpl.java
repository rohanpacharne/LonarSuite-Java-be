...
public class LtMastEmployeesDaoImpl implements LtMastEmployeesDao
{
	...
	public List<LtMastEmployees> findByActiveLikeName(String name) throws ServiceException
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ "%"+ name.toUpperCase() +"%", "%"+ name.toUpperCase() +"%"}, 
				 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
	...
	public LtMastEmployees getByEmployeeNumber(String employeeNumber) throws ServiceException 
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ employeeNumber.trim()}, 
		 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
	...
	public LtMastEmployees getByofficialEmail(String officialEmail) throws ServiceException
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ officialEmail.trim()}, 
		 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
		if(list!=null && list.size()>0)
		return list.get(0);
		else
	...
	public LtMastEmployees getByPersonalEmail(String personalEmail) throws ServiceException 
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ personalEmail.trim()}, 
		 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
		if(list!=null && list.size()>0)
		return list.get(0);
		else
	...
	public LtMastEmployees getByPassportNumber(String passportNo) throws ServiceException 
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ passportNo.trim()}, 
		 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
		if(list!=null && list.size()>0)
		return list.get(0);
		else
	...
	public LtMastEmployees getByPanNumber(String panNo) throws ServiceException 
	{
		...
		List<LtMastEmployees> list=   jdbcTemplate.query(query, new Object[]{ panNo.trim()}, 
		 new BeanPropertyRowMapper<LtMastEmployees>(LtMastEmployees.class)); 
		if(list!=null && list.size()>0)
		return list.get(0);
		else
	...
	public boolean updatePath(LtMastEmployees ltMastEmployees) throws ServiceException
	{
		...
		res1=jdbcTemplate.update(" UPDATE lt_mast_employees SET IMAGE_PATH =? "
				+ "  WHERE EMPLOYEE_ID=? ",
     		ltMastEmployees.getImagePath(),ltMastEmployees.getEmployeeId());
		res1=jdbcTemplate.update(query,ltMastEmployees.getImagePath(),ltMastEmployees.getEmployeeId());
		if(res1!=0)
		{	return true; }
		else
		{	return false; }
	...
	public Long getCount(LtMastEmployees input) throws ServiceException
	{
		String query = env.getProperty("getCountLtMastEmployees");
		   ...
		   {status="%"+input.getStatus().toUpperCase()+"%";}
		    ...
		    {position="%"+input.getPosition().toUpperCase()+"%";}
		
	
		String count  = (String)getJdbcTemplate().queryForObject(
				query, new Object[] {empCode,empName,email,position,status,
	...
	public List<LtMastEmployees> getDatatableRecords(LtMastEmployees input) throws ServiceException {
		String query = env.getProperty("getLtMastEmployeesDatatableRecords");
		   ...
		   {status="%"+input.getStatus().toUpperCase()+"%";}
		    ...
		    {grade="%"+input.getPosition().toUpperCase()+"%";}
			
			
			
			List<LtMastEmployees> list = (List<LtMastEmployees>) 
					jdbcTemplate.query(query , new Object[]{empCode,empName,email,grade,status,
	...
	public String getRoleByEmpId(Long id) throws ServiceException {
		String query = env.getProperty("getEmpRoleByEmpId");
		 
		String role  = (String)getJdbcTemplate().queryForObject(
	...
	public String getCompanyIDByEmpId(Long id) throws ServiceException {
		String query = env.getProperty("getCompanyIDByEmpId");
