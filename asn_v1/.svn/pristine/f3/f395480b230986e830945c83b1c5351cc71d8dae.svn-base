...
public class LtMastVendors extends BaseClass 
{
	...
	public String toString() {
		return "LtMastVendors [vendorId=" + vendorId + ", vendorCode=" + vendorCode + ", vendorName=" + vendorName
				...
				+ proprietorName + ", businessNatureId=" + businessNatureId + ", divisionId=" + divisionId
				+ ", initiatorId=" + initiatorId + ", remark=" + remark + ", primaryEmail=" + primaryEmail
				+ ", msmSupplier=" + msmSupplier + ", asnApprovalRequired=" + asnApprovalRequired
				...
				+ companyCategory + ", divisionName=" + divisionName + ", initiatorName=" + initiatorName + ", message="
				+ message + ", CompanyName=" + CompanyName + ", vendorStatus=" + vendorStatus + ", businessNature="
