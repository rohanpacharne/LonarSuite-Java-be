...
public class LtMastSysVariablesServiceImpl implements LtMastSysVariablesService,CodeMaster
{
	...
	{
		List<SysVariableWithValues> sysVariableWithValuesList=ltMastSysVariablesDao.getBySysVariableName(name,companyId);
	...
	public String checkForDuplicate(LtMastSysVariables ltMastSysVariables) throws ServiceException 
	{
		LtMastSysVariables ltMastSysVariables1 = ltMastSysVariablesDao.getByCode(ltMastSysVariables);
			...
			{
				if(!ltMastSysVariables1.getVariableId().equals(ltMastSysVariables.getVariableId()))
				{
	...
	{
		return ltMastSysVariablesDao.getCount(input,companyId);
	}
	...
	public List<LtMastSysVariables> getDatatableRecords(LtMastSysVariables input,Long companyId) throws Exception 
	{
		...
		return ltMastSysVariablesDao.getDatatableRecords(input,companyId);
	}
