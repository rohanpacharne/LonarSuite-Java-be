...
public class LtMastBuildingsDaoImpl implements LtMastBuildingsDao 
{
	...
	{
		//return em.createNamedQuery("LtP2pBuildings.findByBuildingCode").setParameter("buildingCode", buildingCode).getResultList();
	...
	{
		//return em.createNamedQuery("LtP2pBranches.findByBranchName").setParameter("branchId", branchId).getResultList();
	...
	{
		//return em.createNamedQuery("LtP2pBuildings .findAll").getResultList();
	...
	{
		//return em.createNamedQuery("LtP2pBuildings .findByBuildingId").setParameter("buildingId", buildingId).getResultList();
	...
	{
		//return em.createNamedQuery("LtP2pBuildings .getAddress").setParameter("buildingAddress", "%"+addr.toLowerCase()+"%").getResultList();
	...
	public List<LtMastBuildings> findActiveLikeBuildingAddr(String buildingaddr)throws ServiceException {
		//List<LtP2pBuildings> list=em.createNamedQuery("LtP2pBuildings.findActiveLikeBuildingAddr").setParameter("buildingAddress", "%"+buildingaddr.toLowerCase()+"%").getResultList();
	...
	public List<LtMastBuildings> findByActiveLikeBuildingName(String buildingName) throws ServiceException {
		//return em.createNamedQuery("LtP2pBuildings.findByActiveLikeBuildingName").setParameter("buildingName", "%"+buildingName.toLowerCase()+"%").getResultList();
	...
	public List<LtMastBuildings> findByLikeBuildingName(String buildingName) throws ServiceException {
		//return em.createNamedQuery("LtP2pBuildings.findByLikeBuildingName").setParameter("buildingName", "%"+buildingName.toLowerCase()+"%").getResultList();
	...
	public LtMastBuildings getByBuildingCode(String buildingCode) throws ServiceException {
		String query = env.getProperty("getByBuildingCode");
		List<LtMastBuildings> list=   jdbcTemplate.query(query, new Object[]{buildingCode.toUpperCase()}, 
					 new BeanPropertyRowMapper<LtMastBuildings>(LtMastBuildings.class)); 
	...
	public LtMastBuildings getByBuildingName(String buildingName) throws ServiceException {
		String query = env.getProperty("getByBuildingName");
		List<LtMastBuildings> list=   jdbcTemplate.query(query, new Object[]{buildingName.toUpperCase()}, 
					 new BeanPropertyRowMapper<LtMastBuildings>(LtMastBuildings.class)); 
