...
public class LtMastProdSubCategoriesServiceImpl implements LtMastProdSubCategoriesService,CodeMaster
{
	...
	public List<LtMastProdSubCategories> findLikeSubCategoryName(String name,Long companyId) throws Exception {
		return ltP2pProdSubCategoriesDao.findLikeSubCategoryName(name,companyId);
	}
	...
	public ResponseEntity<Status> save(LtMastProdSubCategories ltMastProdSubCategories) throws ServiceException
	{
		...
		String stat = checkDuplicate(ltMastProdSubCategories);
		if(stat.equals("null")) {
...
//				status=ltMastCommonMessageService.getCodeAndMessage(INSERT_FAIL);
	...
	private String checkDuplicate(LtMastProdSubCategories ltMastProdSubCategories) throws ServiceException {
		LtMastProdSubCategories prodSubCat = ltP2pProdSubCategoriesDao.
				findActiveLikeSubCategoryCodeWithCategoryId(ltMastProdSubCategories.getSubCategoryCode(), ltMastProdSubCategories.getCategoryId());
		if(prodSubCat!=null) {
			if(!prodSubCat.getSubCategoryId().equals(ltMastProdSubCategories.getSubCategoryId())) {
				return "Subcategory code exists for the category.";
			}
		}
		return "null";
	}
...
//				status=ltMastCommonMessageService.getCodeAndMessage(ENTITY_CANNOT_DELETE);
	...
	public Long getCount(LtMastProdSubCategories input,Long companyId) throws ServiceException {
		return ltP2pProdSubCategoriesDao.getCount(input,companyId);
	}
	...
	public List<LtMastProdSubCategories> getDataTable(LtMastProdSubCategories input ,Long companyId) throws ServiceException {
		...
		List<LtMastProdSubCategories> list= ltP2pProdSubCategoriesDao.getDataTable(input,companyId);
		return list;
	}
