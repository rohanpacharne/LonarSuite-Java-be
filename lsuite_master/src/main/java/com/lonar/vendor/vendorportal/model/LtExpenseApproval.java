...
@Entity
@Table(name = "lt_expense_approval")
...
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "expenseApproval_seq")
//	@SequenceGenerator(name = "expenseApproval_seq", sequenceName = "lt_expense_approval_s", allocationSize = 1)
	@JsonView(DataTablesOutput.View.class)
	@Column(name = "EXP_APPROVAL_ID")
