...
//	}
	...
	public String toString() {
		return "LtMastExpenseTypes [expenseTypeId=" + expenseTypeId + ", expenseNature=" + expenseNature
				+ ", expenseDescription=" + expenseDescription + ", expenseType=" + expenseType 
				...
				+ ", glAccountId=" + glAccountId + ", companyId=" + companyId + ", glAccountCode=" + glAccountCode
				+ ", glAccountName=" + glAccountName + ", expenseTypeCode=" + expenseTypeCode + ", draw=" + draw
