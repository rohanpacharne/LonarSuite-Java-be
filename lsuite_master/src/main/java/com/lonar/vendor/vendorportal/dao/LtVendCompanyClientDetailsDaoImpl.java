...
public class LtVendCompanyClientDetailsDaoImpl implements LtVendCompanyClientDetailsDao{
	...
	@Override
	public List<LtCompanyVenMgmtInclude> getCompanyVenClientBycompanyId(Long companyId) throws ServiceException {
		String query = env.getProperty("getCompanyVenClientBycompanyId");
