...
public  class LtMastCostCentersServiceImpl implements LtMastCostCentersService,CodeMaster {
	...
	public ResponseEntity<List<LtMastCostCenters>> findAllActive(Long companyId) throws ServiceException{
		List<LtMastCostCenters> ltMastCostCenters = null;
			...
			ltMastCostCenters = ltMastCostCentersDao.findAllActive(companyId);
	...
	public List<LtMastCostCenters> findByActiveLikeCostCentersName(Long companyId, String costCentersName) throws ServiceException{
		List<LtMastCostCenters> ltMastCostCenters = null;
			...
			ltMastCostCenters = ltMastCostCentersDao.findByActiveLikeCostCentersName(companyId, costCentersName);
			for (LtMastCostCenters ltMastCostCenters2 : ltMastCostCenters) {
				LtMastEmployees ltMastEmployees = new LtMastEmployees();
				if (ltMastCostCenters2.getApproverId() != null) {
					if (ltMastEmployeesRepository.exists(ltMastCostCenters2.getApproverId())) {
	...
	public List<LtMastCostCenters> getDataTable(Long companyId, LtMastCostCenters input) throws ServiceException 
	{
		...
		List<LtMastCostCenters> list= ltMastCostCentersDao.getDataTable(companyId, input);
		return list;
	}
	...
	public Long getCount(Long companyId, LtMastCostCenters input) throws ServiceException {
		return ltMastCostCentersDao.getCount(companyId, input);
	}
	...
	{
		LtMastCostCenters ltMastCostCenters = ltMastCostCentersDao.getLtMastCostCentersByID(costCentersID);
		return ltMastCostCenters;
	}
	...
	public ResponseEntity<List<LtMastCostCenters>> getAll(Long companyId) throws ServiceException {
		...
		List<LtMastCostCenters> ltMastCostCenters = ltMastCostCentersDao.getAll(companyId);
