...
@Entity
@Table(name = "lt_exp_module_approvals")
@JsonInclude(Include.NON_NULL)
public class LtExpModuleApprovals extends WhoColumns implements Serializable
{
	@Id
	@Basic(optional = false)
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "moduleApproval_seq")
//	@SequenceGenerator(name = "moduleApproval_seq", sequenceName = "lt_exp_module_approvals_s", allocationSize = 1)
	...
	private String sort;
	@Transient
	private List<LtExpenseModuleAppEmployees> empList;
	...
	public List<LtExpenseModuleAppEmployees> getEmpList() {
		return empList;
	}
	public void setEmpList(List<LtExpenseModuleAppEmployees> empList) {
